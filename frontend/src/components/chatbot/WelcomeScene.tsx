...
const WelcomeScene = ({ reply, onAction, onAsk }: Props) => (
  <div className="flex min-h-full flex-col">
    ...
    <div className="cb-scene">
      <span className="cb-cloud" style={{ width: 46, height: 16, top: 26, left: 18 }} />
      <span className="cb-cloud" style={{ width: 28, height: 12, top: 19, left: 34 }} />
      <span className="cb-cloud" style={{ width: 38, height: 14, top: 12, right: 96 }} />

      <svg className="cb-hills" viewBox="0 0 380 78" preserveAspectRatio="none" aria-hidden>
        <path d="M0 40c60-22 118 6 190-4s130-26 190-6v48H0Z" fill="#bfe6b8" />
        <path d="M0 56c70-18 130 8 200 0s120-20 180-8v30H0Z" fill="#a6d99e" />
      </svg>

      <div className="relative flex items-start gap-2">
        <p className="cb-bubble m-0">
          {reply.text?.trim() || '안녕하세요 😊 저는 참비예요.\n무엇이든 물어보세요.'}
        </p>

        <div className="ml-auto flex flex-col items-center gap-1 pt-1">
    ...
    <div className="cb-panel">
        ...
        {reply.actions.map((a) => {
          ...
          return (
            ...
            >
              ...
              <p className="cb-card-desc m-0 pr-5">{p.desc}</p>
      ...
      <div className="cb-chips">
        <span className="cb-chips-label">💡 참비가 추천하는 질문</span>
        {RECOMMENDED.map((q) => (
