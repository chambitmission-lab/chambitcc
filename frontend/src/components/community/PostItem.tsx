 ...
 * 개별 게시물 아이템 컴포넌트
 */
export const PostItem = ({ post, onLike, onRetweet }: PostItemProps) => {
  return (
      ...
      <div className="post-content">
        <div className="post-header">
          <div className="post-author">
            ...
            <span className="post-time">{getRelativeTime(post.createdAt)}</span>
          </div>
        </div>
        ...
        <div className="post-actions">
          ...
          <button 
            className={`action-btn ${post.isRetweeted ? 'retweeted' : ''}`}
