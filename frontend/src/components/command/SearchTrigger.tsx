...
export const SearchCapsule = () => {
  ...
  return (
    ...
    >
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" className="search-capsule-icon w-[17px] h-[17px] shrink-0" aria-hidden>
