...
const VersePanel = ({ category, onClose }: { category: SituationCategory; onClose: () => void }) => {
  ...
  return (
    <AdminComposerShell title={category.name} eyebrow="구절 관리" onClose={onClose} width="lg" closeOnBackdrop={false} bare>
        ...
        {/* 구절 목록 */}
        <div className="overflow-y-auto flex-1 min-h-0 divide-y divide-border-light dark:divide-border-dark">
          {isLoading ? (
            ...
            <div key={v.id} className="px-5 py-4">
              <div className="flex items-start gap-3">
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm text-gray-700 dark:text-white/70 mt-0.5 line-clamp-2 lg:line-clamp-none leading-relaxed">{v.text}</p>
