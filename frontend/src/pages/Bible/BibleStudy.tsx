...
const BibleStudy = () => {
  ...
  return (
    <div className="bg-gray-50 dark:bg-background-dark screen-fit-minus-header">
      ...
      <div className="max-w-md mx-auto bg-background-light dark:bg-background-dark shadow-2xl border-x border-border-light dark:border-border-dark screen-fit-minus-header pb-[calc(4.25rem+env(safe-area-inset-bottom))]">
