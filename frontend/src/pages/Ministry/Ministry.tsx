  ...
  const columns: Column[] = [
    {
      ...
      date: '2026.02',
      content: language === 'ko' 
        ? `교회 건물은 다수한 '시설'이나 '건물'이 아닙니다. 비바람을 피하는 장소이기 이전에, 예배와 기도, 만남과 회복이 이루어지는 거룩한 공간입니다. 또한 교회 건물은 사유재가 아니라 공공재적인 성격을 지닌 공간입니다. 누구 한 사람의 뜻대로 위해 존재하는 것이 아니라, 하나님께서 말기신 공동체 전체를 위해 사용되어야 할 공간이기 때문입니다.
...
그런 관점에서 교회 공동체 내 소실을 알릴 때에도 교회 허락을 받아야 하며, 게시적으로 출력하여 아무 곳이나 부착하는 일은 삼가야 합니다. 이달의 좋은 내용이라 하더라도, 방식이 공동체의 질서를 해친다면 그 또한 호려질 수밖에 없습니다. 교회가 정한 공식 양식을 사용하고, 정해진 게시 장소에 부착하는 것 역시 '함께 사용하고, 함께 지켜가는 공간'에 대한 존중의 표현입니다.

시도 바울은 에베소서 2장 22절에서 교회를 이렇게 말합니다. "너희도 성령 안에서 하나님이 거하실 처소가 되기 위하여 예수 안에서 함께 지어져 가느니라." 교회는 흔적가가 아니라 '온자가' 함께 만들어가는 것입니다. 교회는 '누군가가 홀로 완성하는 것'이 아니라, 서로 다른 돌들이 맞물리며 지어가는 살아 있는 공동체입니다. 공간을 사용하는 태도 역시 이 신앙고백과 분리될 수 없습니다.

교회 공간 사용에 있어 또 하나 기억해야 할 부분이 있습니다. 사랑한 후에는 다음 사용자를 위해 깨끗하게 정리하는 점입니다. 의자를 제자리에 두고, 쓰레기를 치우며, 전기 제품 등을 점검하는 일은 작은 보이지만 실은 상당히 중요한 일이 아닙니다. 현재 교회의 전기와 냉난방 사용이 많이 지출되고 있는 현실 속에서, 절약은 서버의 아니라 책임이며, 교회를 향한 우리의 태도를 드러내는 신앙의 문제이기도 합니다.
