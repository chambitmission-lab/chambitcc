  ...
  return (
    <div className="px-4 py-3">
      ...
      >
        {/* 글로우 장식 */}
        <div
          className="pointer-events-none absolute -top-10 -right-10 w-32 h-32 rounded-full bg-white/15 blur-2xl"
          aria-hidden="true"
        />
        <div
          className="pointer-events-none absolute -bottom-12 -left-8 w-28 h-28 rounded-full bg-amber-300/20 blur-2xl"
          aria-hidden="true"
        />
