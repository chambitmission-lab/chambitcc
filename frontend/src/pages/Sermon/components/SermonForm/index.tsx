        ...
        {showRecorder ? (
          ...
          <form onSubmit={handleSubmit} className="flex flex-col h-full overflow-hidden">
            ...
            <div className="flex-shrink-0 bg-background-light dark:bg-background-dark border-b border-border-light dark:border-border-dark px-4 py-3 flex items-center justify-between">
              ...
              >
                {/* 가장 바깥 빛 확산 (크고 은은하게) */}
                <div className="absolute inset-0 rounded-full bg-blue-500/20 dark:bg-yellow-400/20 blur-2xl scale-150 group-hover:scale-[2] animate-pulse transition-transform duration-500"></div>
                
                {/* 중간 빛 레이어 */}
                <div className="absolute inset-0 rounded-full bg-gradient-to-br from-blue-400/50 via-sky-400/50 to-blue-500/50 dark:from-yellow-300/50 dark:via-orange-300/50 dark:to-yellow-400/50 blur-xl scale-125 group-hover:scale-150 animate-pulse transition-transform duration-300"></div>
                
                {/* 강한 빛 레이어 */}
                <div className="absolute inset-0 rounded-full bg-gradient-to-br from-blue-400/70 to-sky-500/70 dark:from-yellow-400/70 dark:to-orange-400/70 blur-lg group-hover:blur-xl animate-pulse"></div>
                
                {/* 내부 빛나는 원 */}
                <div className="absolute inset-0 rounded-full bg-gradient-to-br from-blue-300 via-sky-300 to-blue-400 dark:from-yellow-300 dark:via-orange-300 dark:to-yellow-400 opacity-60 blur-md group-hover:opacity-80 animate-pulse"></div>
                
                {/* 반짝이는 효과 */}
                <div className="absolute inset-0 rounded-full bg-white/40 dark:bg-white/50 blur-sm animate-ping"></div>
                
                {/* X 아이콘 배경 */}
                <div className="absolute inset-0 rounded-full bg-gradient-to-br from-blue-500 to-sky-500 dark:from-yellow-400 dark:to-orange-400 opacity-80 group-hover:opacity-100 shadow-[0_0_30px_rgba(49,130,246,0.8)] dark:shadow-[0_0_40px_rgba(250,204,21,0.9)] group-hover:shadow-[0_0_50px_rgba(49,130,246,1)] dark:group-hover:shadow-[0_0_60px_rgba(250,204,21,1)] transition-all"></div>
            ...
            <div className="flex-1 overflow-y-auto px-4 py-4">
              ...
              <div className="relative mb-3">
                ...
                <div className="backdrop-blur-xl bg-white/40 dark:bg-white/10 rounded-xl p-4 border border-white/60 dark:border-white/20 relative overflow-hidden shadow-[0_8px_32px_rgba(168,85,247,0.15),0_-3px_10px_rgba(168,85,247,0.1),inset_0_1px_1px_rgba(255,255,255,0.6)] dark:shadow-[0_8px_32px_rgba(0,0,0,0.3),0_-3px_10px_rgba(255,255,255,0.1),inset_0_1px_1px_rgba(255,255,255,0.2)]">
                  {/* 내부 빛 효과 */}
                  <div className="absolute top-0 left-1/2 -translate-x-1/2 w-32 h-32 bg-gradient-to-b from-blue-300/30 to-transparent dark:from-white/20 dark:to-transparent rounded-full blur-2xl pointer-events-none"></div>
                  <div className="absolute top-0 right-0 w-24 h-24 bg-gradient-to-br from-blue-400/20 to-sky-400/20 dark:from-white/10 dark:to-white/5 rounded-full blur-2xl pointer-events-none"></div>
            ...
            <div className="flex-shrink-0 px-4 py-3 border-t border-border-light dark:border-border-dark bg-background-light dark:bg-background-dark">
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="flex-1 px-6 py-3 bg-brand text-white font-bold rounded-full hover:shadow-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                >
