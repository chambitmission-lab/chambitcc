  ...
  return (
    <ErrorBoundary>
      <div className="bg-[var(--app-canvas)] min-h-screen page-stage">
        ...
        <div className="max-w-md mx-auto bg-[var(--app-canvas)] shadow-2xl border-x border-border-light dark:border-border-dark min-h-screen lg:max-w-none lg:mx-0 lg:flex-1 lg:min-w-0 lg:rounded-3xl lg:border lg:overflow-hidden lg:min-h-0">
          {/* 헤더 — 플랫 스티키 */}
