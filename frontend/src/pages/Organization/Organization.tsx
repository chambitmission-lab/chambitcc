...
const Organization = () => {
  ...
  return (
    <div className="min-h-screen text-gray-900 dark:text-gray-100 page-stage org-page">
      ...
      <div className="org-shell max-w-md mx-auto border-x border-border-light dark:border-border-dark min-h-screen pb-20 lg:max-w-[1200px] lg:mt-3 lg:mb-12 lg:rounded-3xl lg:border lg:shadow-2xl lg:min-h-0">
        {/* 헤더 */}
