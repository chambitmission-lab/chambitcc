...
const ClassCommentSheet = ({ post, isTeacher, onClose }: ClassCommentSheetProps) => {
  ...
  return (
    ...
    >
      <div
        className="relative w-full sm:max-w-lg h-[85vh] sm:h-[80vh] lg:h-[calc(80vh/var(--az,1))] bg-background-light dark:bg-[#1c1c26] rounded-t-3xl sm:rounded-3xl overflow-hidden border border-black/[0.04] dark:border-white/[0.08] shadow-[0_-12px_40px_rgba(0,0,0,0.5)] flex flex-col"
