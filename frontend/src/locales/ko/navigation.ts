...
export const navigation = {
  ...
  cmdkClose: '닫기',
  // 커맨드 센터 첫 화면
  cmdkActionsTitle: '바로 하기',
  cmdkRecentTitle: '최근 찾은 항목',
  cmdkRecentClear: '지우기',
  cmdkActSermon: '지난 주일 설교',
  cmdkActSermonDesc: '설교 열기',
  cmdkActWorship: '다음 예배',
  cmdkActWorshipDesc: '예배 안내',
  cmdkActVisit: '오시는 길',
  cmdkActVisitDesc: '주차 · 대중교통',
  cmdkActVerse: '오늘의 말씀',
  cmdkActVerseDesc: '본문 펼치기',
  cmdkActChambi: '참비에게 물어보기',
  cmdkActChambiDesc: '무엇이든 대답해요',
  cmdkActFeed: '기도 커뮤니티',
  cmdkActFeedDesc: '기도제목 나누기',
  cmdkActRegister: '1분 회원가입',
  cmdkActRegisterDesc: '처음 오셨나요?',
  ...
  adminNavPastor: '담임목사 인사말',
  adminNavPeople: '섬기는 사람들',
  adminNavEducation: '교육과 훈련',
  adminNavNews: '교회소식 게시판',
