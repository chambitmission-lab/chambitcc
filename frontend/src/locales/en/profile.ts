...
export const profile = {
  ...
  levelHowToEarn: 'How the oil is filled',
  ...
  lampTitle: 'My Lamp',
  lampHint: 'Prayer, the Word and sharing fill your lamp with oil. When it is full, it shines brighter',
  lampVerse: '"The wise took oil in their vessels with their lamps" (Matt 25:4)',
  lampFilled: 'filled with oil',
  lampUntil: ' in',
  levelJourneyHere: 'You are here',
  levelNext: 'Next',
  levelToNextStage: 'To next stage',
  levelNextLabel: 'Next level',
  levelHint: 'Starts at 36.5°C and warms up with prayer, Word and sharing',
  levelHowToEarnSub: 'Draw closer to God through prayer, the Word and service',
  growthGraphTitle: 'Faith Growth Graph',
  growthGraphMore: 'See more',
  profileMyTitle: 'My title',
