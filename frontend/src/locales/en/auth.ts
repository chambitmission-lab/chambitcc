...
export const auth = {
  ...
  registerFullNameHelp: 'Up to 15 characters. This is how we will greet you at church. Names must be unique — add a number if yours is taken.',
  registerFullNameTooLong: 'Names can be up to 15 characters',
  registerUsername: 'Username',
  registerUsernameHelp: '2–12 characters, no spaces. Korean characters are welcome too.',
  registerUsernameLength: 'Usernames must be 2–12 characters',
