...
export const navigation = {
  ...
  navDescPeople: 'Pastors · missionaries · elders · staff',
  navDescOrganization: 'Teams and committees',
  ...
  navDescSurvey: 'Share your thoughts with us',
  navDescSeats: 'Pick your seat for concerts & events',
  navNewFamilyAlbum: 'Newcomers',
  navDescNewFamily: 'Welcoming those who just arrived',
  navDescNews: 'News and announcements',
  navDescBible: 'Read · search · reading plans',
  navDescMyGroups: 'Small-group prayer rooms',
  ...
  cmdkSelect: 'open',
  cmdkClose: 'close',
  cmdkActionsTitle: 'Quick actions',
  cmdkRecentTitle: 'Recent',
  cmdkRecentClear: 'Clear',
  cmdkActSermon: "Last Sunday's sermon",
  cmdkActSermonDesc: 'Open sermon',
  cmdkActWorship: 'Next service',
  cmdkActWorshipDesc: 'Worship times',
  cmdkActVisit: 'Directions',
  cmdkActVisitDesc: 'Parking · transit',
  cmdkActVerse: "Today's verse",
  cmdkActVerseDesc: 'Open the passage',
  cmdkActChambi: 'Ask Chambi',
  cmdkActChambiDesc: 'Answers anything',
  cmdkActFeed: 'Prayer community',
  cmdkActFeedDesc: 'Share a prayer',
  cmdkActRegister: 'Sign up in a minute',
  cmdkActRegisterDesc: 'New here?',
